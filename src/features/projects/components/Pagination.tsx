  ...
  return (
    <>
        <div className="flex items-center gap-2 text-label-sm cursor-pointer">
            ...
            <div className="w-8 h-8 border border-border rounded-xs flex items-center justify-center text-white bg-primary">1</div>
            <div className="w-8 h-8 border border-border rounded-xs flex items-center justify-center text-[#434654]">2</div>
            <div className="w-8 h-8 border border-border rounded-xs flex items-center justify-center text-[#434654]">
